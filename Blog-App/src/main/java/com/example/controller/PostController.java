...
public class PostController {
	...
	@GetMapping("/posts")
	public ResponseEntity<List<Post>> getPosts(@RequestParam(value = "page", defaultValue = "5", required = false) int page,
			@RequestParam(defaultValue = "5", required = false) int size) {

		List<Post> posts = this.postService.getAllPosts(page, size);
